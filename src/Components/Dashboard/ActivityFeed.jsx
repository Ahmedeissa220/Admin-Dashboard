  ...
  return (
    <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-200/50 dark:border-slate-700/50">
      ...
      <div className="p-4 md:p-6 border-b border-slate-200/50 dark:border-slate-700/50 flex items-center justify-between">
        ...
        <button className="text-blue-400 hover:text-blue-700 text-xs md:text-sm font-medium">
          View All
        </button>
      </div>
        ...
        <div className="space-y-3 md:space-y-4">
          {activities.map((activity) => {
            return (
              <div
                key={activity.id}
                className="flex items-start space-x-3 md:space-x-4 p-2 md:p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition"
              >
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-xs md:text-sm font-semibold text-slate-800 dark:text-white">
                    {activity.title}
                  </h4>
