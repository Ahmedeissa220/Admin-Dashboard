...
function RevnueChart() {
  ...
  return (
    ...
    border-slate-200/50 dark:border-slate-700/50 p-4 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 md:mb-6 gap-3">
        ...
        <div className="flex items-center space-x-3 md:space-x-4 text-xs md:text-sm">
          <div className="flex items-center space-x-1">
            <div className="w-2.5 h-2.5 md:w-3 md:h-3 bg-gradient-to-b from-blue-500 to-purple-600 rounded-full"></div>
            <span className="text-slate-600 dark:text-slate-400">Revenue</span>
          </div>

          <div className="flex items-center space-x-1">
            <div className="w-2.5 h-2.5 md:w-3 md:h-3 bg-gradient-to-b from-slate-400 to-slate-500 rounded-full"></div>
